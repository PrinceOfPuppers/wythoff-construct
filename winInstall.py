...
if __name__ == "__main__":
    ...
    if platform == 'win32' or platform =='amd64':
        traitsURL = f"https://download.lfd.uci.edu/pythonlibs/z4tqcw5k/traits-6.1.1-{ver}-{ver}-{platform}.whl"
        vtkURL = f"https://download.lfd.uci.edu/pythonlibs/z4tqcw5k/VTK-9.0.1-{ver}-{ver}-{platform}.whl"
